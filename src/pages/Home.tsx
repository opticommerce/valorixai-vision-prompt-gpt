        ...
        <section className="py-20 px-4 bg-backgroundAlt dark:bg-[#1A1A1A]">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-14 text-primaryText dark:text-white font-inter">
              What Makes Valorix Prompt Seller So Powerful?
            </h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-[#1E1E1E] p-8 rounded-xl shadow-soft dark:shadow-[0_0_0_1px_rgba(255,255,255,0.05)] hover:shadow-[0_0_12px_rgba(132,204,22,0.35)] dark:hover:shadow-[0_0_12px_rgba(132,204,22,0.35)] hover:scale-105 transform transition-transform duration-300 ease-in-out">
                ...
                <p className="text-secondaryText dark:text-gray-400 leading-relaxed">
                  The Prompt Builder creates optimized AI prompts to help you generate high-quality product descriptions using AI tools like ChatGPT, Claude, Gemini, and others. Simply input key details such as category, material, and style, and the tool will generate a structured prompt tailored to your needs. Each prompt is dynamically crafted based on your input, ensuring originality and variation every time, allowing you to refine and customize descriptions as needed.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#1E1E1E] p-8 rounded-xl shadow-soft dark:shadow-[0_0_0_1px_rgba(255,255,255,0.05)] hover:shadow-[0_0_12px_rgba(132,204,22,0.35)] dark:hover:shadow-[0_0_12px_rgba(132,204,22,0.35)] hover:scale-105 transform transition-transform duration-300 ease-in-out">
                ...
                <p className="text-secondaryText dark:text-gray-400 leading-relaxed">
                  No, you can generate as many prompts as you like! Unlike other tools that have usage limits or require monthly subscriptions, Valorix Prompt Seller allows unlimited prompt creation with a single purchase.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#1E1E1E] p-8 rounded-xl shadow-soft dark:shadow-[0_0_0_1px_rgba(255,255,255,0.05)] hover:shadow-[0_0_12px_rgba(132,204,22,0.35)] dark:hover:shadow-[0_0_12px_rgba(132,204,22,0.35)] hover:scale-105 transform transition-transform duration-300 ease-in-out">
                ...
                <p className="text-secondaryText dark:text-gray-400 leading-relaxed">
                  Yes! The Valorix Prompt Seller is designed to generate high-quality prompts based on the details you provide. Each prompt is structured to ensure relevance and clarity, helping AI assistants create the most compelling product descriptions for your audience.
                </p>
              </div>
            </div>
          </div>
